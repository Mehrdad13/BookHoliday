...
import java.awt.*; 
  import java.awt.event.*; 
   ...
   public class MyFrame 
      extends JFrame 
      implements ActionListener, IRegisterUser { 
     ...
     { 
         ...
         SearchFlight.setFont(new Font("Arial", Font.PLAIN, 15));
         SearchFlight.setSize(100, 20);
         SearchFlight.setLocation(650, 50);
     ...
     { 
          if (e.getSource() == sub) { 
             ...
             resadd.setText(def); 
         }else if(e.getSource()==SearchFlight) {
