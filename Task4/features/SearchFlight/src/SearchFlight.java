...
public class SearchFlight extends JFrame implements ActionListener, interfaces.ISearchFlight {

	
	
    private boolean searchhotel=false;
	private Container c;
